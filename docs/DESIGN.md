...
> Design notes for **fintech-payment-sms-audit** — a runnable python example that Typed Python service that sends risk-sensitive payment SMS alerts and records delivery status.
...
- **Feature code** — the actual task: payment-risk-alerts.
